...
/**
 * Clase que representa a la primitiva FlushQ.
 */

public class FlushQ extends ClienteUnitario {
    ...
    public static void main(String[] args) throws java.io.IOException {
        if (args.length != 2) {
            System.out.println("\u001B[33mUso: java sdis.broker.client.unit.FlushQ host clave\u001B[0m");
            System.exit(-1);
        }
        ...
        try {
            // ejecuta el metodo ejecutar de cliente unitario para la primitiva FlushQ
            ejecutar(host, new MensajeProtocolo(Primitiva.FLUSHQ, clave));
