...
/**
 * Clase que representa a la primitiva ReadQ
 */
public class ReadQ extends ClienteUnitario {

    /**
     * Metodo principal que recibe los parámetros desde la línea de comandos y ejecuta la operación
     * de lectura de una cola.
    ...
    public static void main(String[] args) throws java.io.IOException {
        if (args.length != 2) {
            System.out.println("\u001B[33mUso: java sdis.broker.client.unit.ReadQ host clave\u001B[0m");
            System.exit(-1);
        }
        ...
        try {
            // ejecuta el metodo ejecutar de cliente unitario para la primitiva ReadQ
            ejecutar(host, new MensajeProtocolo(Primitiva.READQ, clave));
