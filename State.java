...
/**
 * Clase que representa a la primitiva State
 */
public class State extends ClienteUnitario {
    ...
    public static void main(String[] args) throws java.io.IOException {
        if (args.length != 1) {
            System.out.println("\u001B[33mUso: java sdis.broker.client.unit.State host\u001B[0m");
            System.exit(-1);
        }
        ...
        try {
            ...
            ejecutar(host, new MensajeProtocolo(Primitiva.STATE));
